...
It brings together more than 80 datasets, grouped by topic and sorted for easier access — from **OpenStreetMap** to **population models**, **satellite imagery**, and **Russia-specific sources**.
...
Если вы знаете интересный источник — нажмите **Добавить** в верхней части страницы - это будет очень полезно.
